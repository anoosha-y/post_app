    ...
    <div class="col-lg-8">
        ...
        {{-- <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                <h2 class="card-title">some title here</h2>
        ...
        <div class="row">
            ...
            @foreach ($posts as $post)
                <div class="card mb-4" style="width: 18rem; margin: 10px;">
                    <h5 class="card-title">{{$post->name}}</h5>
                    <p class="card-title">{{$post->users->name}}</p>
                    ...
                    <div class="likes">
                        ...
                        @endforeach --}}
                        {{count($post->likes)}}
                        <a href="{{ route('like.show', ['id'=>$post->id]) }}"><i class="fa fa-heart-o" aria-hidden="true"></i></a>
                
                        {{-- <form action="{{route('like.show', ['id'=>$post->id])}}" method="POST"> {{ csrf_field() }}
